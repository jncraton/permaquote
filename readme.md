...
Quote cited excerpts from anything with a [URI](https://en.wikipedia.org/wiki/Uniform_Resource_Identifier)
...
| Service                                  | Free | Transparent Source | Complete Archive | Book Support |
|:-----------------------------------------|:----:|:------------------:|:----------------:|:------------:|
| permaquote                               |  ✔   | ✔                  |                  | ✔            |
